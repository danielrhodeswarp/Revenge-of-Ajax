...
include $_SERVER['DOCUMENT_ROOT'] . '/../php/someother_ajax_model.php';
...
class SomeotherAjaxControl
{
	...
	{
		$this->ajaxModel = new SomeotherAjaxModel();
	}
...
//main
$ajaxControl = new SomeotherAjaxControl();
